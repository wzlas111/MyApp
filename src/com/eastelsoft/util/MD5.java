...
public class MD5 {
    ...
    /*
     * getkeyBeanofStr是类keyBean最主要的公共方法，入口参数是你想要进行keyBean变换的字节数组
     * 返回的是变换完的结果，这个结果是从公共成员digestHexStr取得的．
     */
    public byte[] getKeyBeanofByte(byte[] inbuf) {
    	keyBeanInit();
        keyBeanUpdate(inbuf, inbuf.length);
        keyBeanFinal();
        return digest;
    }
