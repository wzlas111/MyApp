...
public class DeskClockMainActivity extends Activity implements
	...
	private void addNewAlarm() {
		startActivity(new Intent(this, DeSetAlarmActivity.class));
	}
	...
	private class AlarmTimeAdapter extends CursorAdapter {
		...
		public void bindView(View view, Context context, Cursor cursor) {
			...
			// 设置日期
			TextView mmdate = (TextView) digitalClock
					.findViewById(R.id.myDate);
			final String mmdateStr = alarm.theday;
			if (mmdateStr != null && mmdateStr.length() != 0) {
				mmdate.setText(mmdateStr);
				mmdate.setVisibility(View.VISIBLE);
			} else {
				mmdate.setVisibility(View.GONE);
			}
			...
			final String daysOfWeekStr = alarm.daysOfWeek.toString(
					DeskClockMainActivity.this, false);
	...
	private void updateIndicatorAndAlarm(boolean enabled, ImageView bar,
		...
		if (enabled) {
			DeSetAlarmActivity.popAlarmSetToast(this, alarm.hour,
					alarm.minutes, alarm.daysOfWeek, alarm.theday);
		}
	}
...
//			Intent intent = new Intent(this, DeSetAlarmActivity.class);
