package com.eastelsoft.lbs.navi;
...
private View navigatorView;
	public void onCreate(Bundle savedInstanceState){
		...
		navigatorView=findViewById(R.id.nMap);
		//创建导航视图
		navigatorView = BNavigator.getInstance().init(BNavigatorActivity.this, getIntent().getExtras(), nMapView);
