...
public class McCompanyNatureActivity extends Activity {
	...
	private void initView() {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				Intent intent = new Intent(McCompanyNatureActivity.this, VisitMcRegisterActivity.class);
	...
	private class InitDataTask extends AsyncTask<String, Integer, Boolean> {
		...
		protected Boolean doInBackground(String... params) {
			try {
				mList = ParamsDBTask.getEnterpriseTypeList();
			} catch (Exception e) {
				e.printStackTrace();
				mList = new ArrayList<SelectBean>();
			}
		...
		protected void onPostExecute(Boolean result) {
			...
			mAdapter = new SelectAdapter(McCompanyNatureActivity.this, mList, mId);
			mListView.setAdapter(mAdapter);
		}
	}
