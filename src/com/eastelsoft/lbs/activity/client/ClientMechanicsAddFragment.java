...
public class ClientMechanicsAddFragment extends Fragment implements OnClickListener{
	...
	public ClientMechanicsAddFragment(String id) {
		mId = id;
	}
	...
	private void addTableRow(int row) {
		View view = LayoutInflater.from(getActivity()).inflate(R.layout.widget_mechanics_add_table, null);
