...
public class ClientInfoEditFragment extends Fragment implements OnClickListener{
	...
	public ClientInfoEditFragment(String id) {
		mId = id;
	}
	...
	private void fillData() {
		...
		typename.setText(mBean.type_name);
