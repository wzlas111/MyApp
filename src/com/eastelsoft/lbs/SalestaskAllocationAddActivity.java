 ...
 * @author xl
 */
public class SalestaskAllocationAddActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		listadpter = new SalesAllocationAddAdapterA(
				SalestaskAllocationAddActivity.this, all_info);
		// 填充适配器
	...
	protected void openPopupWindowCust(String msg) {
		try {
			...
			cadapter = new CustSelectAdapter(
					SalestaskAllocationAddActivity.this, mData_tp);
	...
	private class OnBtAddInfoClickListenerImpl implements OnClickListener {
		public void onClick(View v) {
			try {
				...
				SalestaskAllocationAddActivity.this.openPopupWindowPG("");
	...
	class AddInfoThread implements Runnable {
		...
		public void run() {
			...
			try {
				...
				respMsg = getResources().getString(R.string.allocation_upload_err);
				msg.what = 2;
				msg.obj = respMsg;
				handler.sendMessage(msg);
			}
			...
			try {
				...
				case 3:
					...
					if ("1".equals(msg.obj.toString())) {
						...
						try {
							...
							Toast.makeText(
									SalestaskAllocationAddActivity.this,
									getResources().getString(
											R.string.allocation_upload_succ),
									Toast.LENGTH_SHORT).show();
							SalestaskAllocationAddActivity.this.finish();
						} catch (Exception e) {
				...
				case 6:
					...
					if (all_info.size() > 0) {
						...
						Toast.makeText(SalestaskAllocationAddActivity.this,
	...
	protected class OnBtCloseLokClickListenerImpl implements OnClickListener {
		public void onClick(View v) {
			try {
				...
				Toast.makeText(SalestaskAllocationAddActivity.this, "存入本地成功",
						Toast.LENGTH_SHORT).show();
				SalestaskAllocationAddActivity.this.finish();

			} catch (Exception e) {
				FileLog.e(TAG, e.toString());
				Toast.makeText(SalestaskAllocationAddActivity.this, "存入本地失败",
						Toast.LENGTH_SHORT).show();
	...
	private class OnEdAreaClickListenerImpl implements OnClickListener {
		public void onClick(View v) {
			try {
				...
				new DatePickerDialog(SalestaskAllocationAddActivity.this, d,
