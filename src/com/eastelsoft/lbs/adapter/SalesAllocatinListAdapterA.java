...
public class SalesAllocatinListAdapterA extends BaseAdapter {
	
	private LayoutInflater mInflater;    
    private  ArrayList<SalestaskAllocationBean> arraylists ;    
    private Context context;
    


	public SalesAllocatinListAdapterA(Context context,ArrayList<SalestaskAllocationBean> arraylists) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {    
            ...
            convertView = mInflater.inflate(R.layout.salesallocatin_list_item, null);  
        ...
        //holder.task_update.setText("234567");    
